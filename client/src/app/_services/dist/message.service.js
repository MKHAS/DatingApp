...
var MessageService = /** @class */ (function () {
    ...
    // 229: by adding the async decorator we guarantee we return a promise from this message
    MessageService.prototype.sendMessage = function (username, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.hubConnection
                        .invoke('SendMessage', { recipientUsername: username, content: content })["catch"](function (error) { return console.log(error); })];
            });
        });
    };
