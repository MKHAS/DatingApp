...
var ConfirmService = /** @class */ (function () {
    ...
    ConfirmService.prototype.confirm = function (title, message, btnOkText, btnCancelText) {
        ...
        this.bsModalRef = this.modalService.show(confirm_dialog_component_1.ConfirmDialogComponent, config);
        return new rxjs_1.Observable(this.getResult());
    };
    ConfirmService.prototype.getResult = function () {
        var _this = this;
        return function (observer) {
            var subscription = _this.bsModalRef.onHidden.subscribe(function () {
                observer.next(_this.bsModalRef.content.result);
                observer.complete();
            });
            return {
